...
const SUB_PATH = process.env.SUB_PATH || '0';       // 订阅路径
const PORT = process.env.SERVER_PORT || process.env.PORT || 3000;        // http服务订阅端口
const UUID = process.env.UUID || 'aa4ae372-8250-4829-8918-c21309881b62'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
...
const NAME = process.env.NAME || '0';                        // 节点名称
